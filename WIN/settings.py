...
SECRET_KEY = 'l#u&z4rq5m00=!+51u%p3_cus&z19ki^ojjdbcli!+@$-uaj(9'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'WIN', 'static'),
)
SITE_ID = 1
...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, 'WIN', 'templates'),
    os.path.join(BASE_DIR, 'Testimonial', 'Templates'),
)
